...
function FieldFilterableInput({ field, handleFilterChange }) {
  const getCheckboxFilterElements = (field) => {
    const priorities = fieldRecordImportPriorityOptions.map((priorityValue, index) => (
      <Checkbox
        key={index}
        name="priorities"
